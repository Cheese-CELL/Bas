...
namespace GorillaTagModTemplateProject
{
	...
	[BepInPlugin(Bas.PluginInfo.GUID, Bas.PluginInfo.Name, Bas.PluginInfo.Version)]
	public class Plugin : BaseUnityPlugin
	{
		...
		public void sizechanger()
		{
			if (inRoom)
			{
				...
				if (GorillaLocomotion.Player.Instance.scale < .08f)
				{
					GorillaLocomotion.Player.Instance.scale = .08f;
